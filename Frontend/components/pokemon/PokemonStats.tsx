...
export function PokemonStats ({style, color, name, value, ...rest}: Props){
    const colors = useThemeColors();
    const sharedValue = useSharedValue(value);

    const barInnersStyle = useAnimatedStyle(() => {
        return {
    ...
    return <Row gap={8} style={[style, styles.root]} {...rest}>
        ...
        <Row style={styles.bar}>
            <Animated.View style={[styles.barInner, { backgroundColor: color}, barInnersStyle]} />
